...
export function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-100/60 backdrop-blur-sm transition-opacity duration-200"
      onClick={handleClose}
    >
      <div
        className="bg-card rounded-2xl shadow-xl border border-stone-200/60 p-6 w-full max-w-md max-h-[90vh] overflow-y-auto"
      ...
      >
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            onClick={handleClose}
            className="text-muted-foreground hover:text-foreground transition-colors rounded-full p-1 hover:bg-stone-100"
          >
